...
export default function BookingForm() {
  ...
  const handleWhatsApp = () => {
    ...
    window.open(`https://wa.me/6281333329181?text=${message}`, "_blank");
  };
            ...
            <div className="hidden-print-area">
              <div className="receipt-container p-6 text-black bg-white font-mono text-[12px] leading-tight w-[80mm] mx-auto text-left border border-gray-200">
                <div className="text-center border-b border-dashed border-black pb-3 mb-3">
                  ...
                  <p className="text-[10px]">Jl. Teknisi No. 7, Jakarta Utara</p>
                  <p className="text-[10px]">WA: 0888-8771-981</p>
                </div>
